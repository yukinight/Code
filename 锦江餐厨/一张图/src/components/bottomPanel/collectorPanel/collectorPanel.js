...
const CollectorPanel = ({dispatch,collectorQty,rubQty,rules,relatedMerchs,
	tableData,searchText,areaOptions,areaFilter,stateOptions,stateFilter})=>{
...
export default connect(({collectorPanel})=>collectorPanel)(CollectorPanel);